...
vector<vector<double>> Matrix_T(vector<vector<double>> a,const int& n);                         //求矩阵转置
...
vector<vector<double>> Matrix_Subtracition(vector<vector<double>> a, vector<vector<double>> b); //矩阵相减
